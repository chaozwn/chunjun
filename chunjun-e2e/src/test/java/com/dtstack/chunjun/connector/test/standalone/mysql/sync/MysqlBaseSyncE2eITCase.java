...
public class MysqlBaseSyncE2eITCase extends ChunjunFlinkStandaloneTestEnvironment {
    ...
    public void testMysqlToMysql(MysqlBaseContainer genericContainer) throws Exception {
        ...
        JdbcProxy proxy =
            new JdbcProxy(jdbcUrl, genericContainer.getUsername(), genericContainer.getPassword(), genericContainer.getDriverClassName());
        ...
        proxy.checkResultWithTimeout(
            expectResult,
            "test_sink",
            new String[] {"id", "name", "idcard", "birthday", "mobile", "email", "gender", "create_time", "type_smallint", "type_mediumint",
